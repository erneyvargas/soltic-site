...
export default function Footer() {
  return (
    <footer className="relative border-t border-line/50 py-12">
      <div className="container-x">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
          <Logo />
          <nav className="flex flex-wrap gap-x-8 gap-y-3 text-sm text-mute">
            <a href="#servicios" className="hover:text-ink">Servicios</a>
            <a href="#enfoque" className="hover:text-ink">Enfoque</a>
            <a href="#resultados" className="hover:text-ink">Resultados</a>
            <a href="#contacto" className="hover:text-ink">Contacto</a>
          </nav>
          <div className="flex items-center gap-3">
            {[
              { I: Icon.Linkedin, href: "#", label: "LinkedIn" },
              { I: Icon.Github, href: "#", label: "GitHub" },
              { I: Icon.Instagram, href: "#", label: "Instagram" },
            ].map(({ I, href, label }) => (
              <a
                key={label}
                href={href}
                aria-label={label}
                className="grid size-9 place-items-center rounded-full border border-line/80 bg-surface text-mute transition hover:border-gold/50 hover:text-gold"
              >
        ...
        <div className="flex flex-col justify-between gap-2 text-xs text-mute md:flex-row">
          ...
          <div className="flex gap-5">
            ...
            <a href="#" className="hover:text-ink">NIT 000.000.000-0</a>
          </div>
        </div>
      </div>
    </footer>
